			...
			<c:otherwise>
				...
				<tr>
					...
					<td>
						...
						<input type="button" value="수정" onclick="location.href='AdminCarUpdate.ad?car_id=${carList.car_id}'">
						<input type="button" value="삭제" onclick="location.href='AdminCarDelete.ad?car_id=${carList.car_id }'">													
					</td>
				</tr>			
				</c:forEach>
			</c:otherwise>
