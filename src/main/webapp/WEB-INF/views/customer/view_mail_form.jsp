							...
							<section class="section-form">
								...
								<div class="form-cont">
										...
										<div class="input-cont">
											<div class="inputT">
												<div id="board_subject">
													<span class="it-notice">${mailForm.board_progress}</span>
									...
									<div class="row type2">
										...
										<div class="input-cont">
											<div class="inputT">
												<div id="board_date">${mailForm.board_date}</div>
											</div>
										</div>
									</div>
									<div class="row type2">
									...
									<div class="form-cont">
										<div class="row type2">
											...
											<div class="input-cont">
												<div class="inputT">
													<div id="board_subject">
														<span class="it-notice">${mailForm2.board_progress}</span>
										...
										<div class="row type2">
											...
											<div class="input-cont">
												<div class="inputT">
													<div id="board_date">${mailForm2.board_date}</div>
												</div>
											</div>
										</div>
										<div class="row type2">
