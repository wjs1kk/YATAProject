								...
								<fieldset>
									<section class="section-form">
										<div class="form-header">
											<h2 class="tit-size-mid">${notice.board_content}</h2>
										</div>
										<div class="form-cont">
											<div class="row type2">
...
<!-- 											</div> -->
								...
								<section id="commandList">
									...
									<input type="button" value="삭제"
										onclick="location.href='deleteView.no?board_num=${notice.board_num}'">
								</section>
							</form>
						</div>
					</div>
